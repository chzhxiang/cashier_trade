 ...
 * @ClassName: ResponseHandler.java
 * @Statement: <p>
 ...
 * @Version: 1.0
 */
@SuppressWarnings(value = { "rawtypes", "unchecked", "static-access" })
public class ResponseHandler {
	...
	public void doParse(String xmlContent) throws IOException {
	...
	public boolean isWXsign() {
		...
		signParams.put("appkey", this.appkey); // V2版的
