...
import com.sunshine.payment.unionpay.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;
...
public class HttpClient {
	...
	private String response(final HttpURLConnection connection, String encoding)
		...
		try {
			logger.info("银联HTTP请求返回状态:{}", connection.getResponseCode());
