    ...
    <div class="widget-content radius-3">
        <form class="form-horizontal patient-info">
            <div class="control-group order-group">
                ...
                <span class="span3">
                    <input type="text" placeholder="请输入企业名称" id="merchantName">
                </span>
            </div>
            <div class="control-group order-group">
                <span class="span1"><span style="color:red;">*</span>企业联系地址</span>
                <span class="span3">
                    <input type="text" placeholder="请输入企业联系地址" id="merchantAddress">
                </span>
            </div>
        </form>
    </div>
    ...
    <div class="widget-content radius-3">
        <form class="form-horizontal patient-info">
            <div class="control-group order-group">
                ...
                <span class="span3">
                    <input type="text" placeholder="请输入联系人姓名" id="linkmanName">
                </span>
            </div>
            <div class="control-group order-group">
                <span class="span1"><span style="color:red;">*</span>联系人电话</span>
                <span class="span3">
                    <input type="text" placeholder="请输入联系人电话" id="mobile">
                </span>
            </div>
            <div class="control-group order-group">
                <span class="span1">联系人QQ</span>
                <span class="span3">
                    <input type="text" placeholder="请输入联系人QQ" id="qq">
                </span>
            </div>
            <div class="control-group order-group">
                <span class="span1">联系人邮箱</span>
                <span class="span3">
                    <input type="text" placeholder="请输入联系人邮箱" id="email">
                </span>
            </div>
        </form>
    </div>
